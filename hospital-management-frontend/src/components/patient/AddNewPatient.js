    ...
    <div>
      ...
      >
        ...
        <Modal.Body>
          ...
          <div style={{ marginTop: "15px" }}>
            {submitBool && bloodGroup == "select Blood group" ? (
              <h6 className="emptyFieldWarning">
          ...
          {/*----------------------------------- ward type-------------------  */}
          <div style={{ marginTop: "15px" }}>
            {submitBool && type == "select ward type" ? (
          ...
          <div>
            ...
            {submitBool && wardFullFlag ? (
              <div style={{ color: "red" }}>*ward is full</div>
            ) : (
              <div></div>
            )}
            {submitBool && bedAlloted == 0 ? (
              <h6 className="emptyFieldWarning">
          ...
          {/* ====================================security question================================= */}
          <div>
            {submitBool && securityQuestion == "select security question" ? (
              <h6 className="emptyFieldWarning">
          ...
          <div>
            ...
            <input
              ...
              required
            />
            {submitBool && patientProblem.length < 5 ? (
              <h6 className="emptyFieldWarning">
