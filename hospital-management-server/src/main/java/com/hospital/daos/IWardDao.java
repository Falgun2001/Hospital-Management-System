...
public interface IWardDao extends JpaRepository<Ward, Integer> {
	...
	int insertIntoWardTable(@Param("id") int id, @Param("type") String type, @Param("charges") double charges,
			@Param("availability") double availability, @Param("max_capacity") double max_capacity);
