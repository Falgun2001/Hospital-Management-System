...
//	pat_id, medicine_id, prescription, medicine_qty
	...
	int addIntoMedicineAssigned(@Param("patId") int patId, @Param("medicineId") int medicineId,
			@Param("prescription") String prescription, @Param("medicineQty") int medicineQty);
